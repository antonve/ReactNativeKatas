    ...
    <View style={[styles.container, { alignItems: "stretch" }]}>
      <View
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ width: 80, height: 80, backgroundColor: "#229E85", borderRadius: 40, marginBottom: 20 }} />
          <View style={{ marginLeft: 20, marginTop: 10, alignItems: "flex-start" }}>
        ...
        <View style={{}}>
          ...
          <Text style={{ color: "white" }}>
            <Icon name="ios-send-outline" size={16} /> chuck@norrisfamily.arpa
          </Text>
        </View>
      </View>
    </View>
